...
intro:
  ...
  body: |
    ...
    New people are rolling up their sleeves for the work ahead. And so we remember from [Progress Takes Work](https://www.navapbc.com/values/): “We believe the future belongs to the people who are willing to make change happen, and we are grateful to play our part.” [We hope you’ll join us as well](https://www.navapbc.com/careers/working-at-nava).
...
section_4:
  ...
  body: |
    ...
    To move quickly and safely on a large project like this, we work iteratively by launching small pieces and then improving on them.  We launched the first version of cloud.cms.gov as a type-preset-6d website that provided a high-level overview of CMS Cloud. The simple structure was easy to update so we could continue to make improvements while also saving engineering resources until we really needed them—when the platform became more robust and interactive.
