...
import FilteredPostList from "./FilteredPostsList";
...
export default {
   ...
   */
  title: "Blocks / Core Blocks / Filtered Post List",
  component: FilteredPostList,
} as ComponentMeta<typeof FilteredPostList>;

//👇 We create a “template” of how args map to rendering
const Template: ComponentStory<typeof FilteredPostList> = (args) => (
  <FilteredPostList {...args}></FilteredPostList>
);
