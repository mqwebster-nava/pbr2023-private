    ...
    <header key={id}>
      <div className={`${header.bg}`}>
        <div className={`responsive-container relative z-10  `}>
          ...
          <div
            className={` absolute  z-10 top-[72px] lg:top-[128px]  h-full pr-xl md:pr-4xl 2xl:pr-0 2xl:mx-auto 2xl:max-w-screen-xl `}
          >
            <h1
              className={`animate-titleSlide font-sans type-preset-1 text-white font-black pb-md w-3/4`}
            >
              {title}
            </h1>
      ...
      <div className=" relative responsive-container ">
        <div
          className={`  ${header.bg} -mt-[3px]  h-1/2 w-full absolute z-0 top-0 left-0 lg:left-1/2 lg:w-screen lg:-translate-x-1/2`}
        ></div>
        <div className={`w-3/4 lg:w-1/2 ml-auto aspect-[4/3] ${header.illBg} z-20`}>
          <CrossfadeCarousel
            interval={2000}
            transition={2000}
