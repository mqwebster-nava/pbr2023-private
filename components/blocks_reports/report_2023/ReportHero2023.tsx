...
const ReportHero2023 = ({activeSection, setActiveSection, setActiveStory}, {}: PageHeaderInterface) => {
  ...
  return (
    ...
    >
      <div
        className={`responsive-container w-full max-h-32 flex flex-row justify-between pt-8 pb-2 md:pt-8 md:pb-4 relative font-sans font-black text-3xl !leading-none tracking-[0px] md:tracking-[-0.5px] sm:text-5xl md:text-6xl lg:text-7xl`}
      >
