...
export const categories = {
  ...
  "Individual_Contributor_percentage": { display: "Individual Contributors", total: 98 },
  "Team_Lead_percentage": { display: "Team Leads", total: 15 },
  "Manager_percentage": { display: "Managers", total: 44 },
  "Director_percentage": { display: "Directors", total: 7 },
  "VP_percentage": { display: "VP & C Suite", total: 9 },
}
...
export const race = {
  ...
  "selfReported": "* Self-reported identities include: Ashkenazi Jewish, Australasian, and Chicano.",
